        ...
        while(iterator.hasNext())
        {
            ...
            try {
                 ...
                 */
                    ...
                    if(String.class.isAssignableFrom(fieldTargetType)){
                        field.set(object, parameterValue[0]);
                    }else if(Integer.class.isAssignableFrom(fieldTargetType)){
                        field.set(object, Integer.parseInt(parameterValue[0]));
                    }else if(int.class.isAssignableFrom(fieldTargetType)){
                        field.set(object, Integer.parseInt(parameterValue[0]));
                    }else if(Long.class.isAssignableFrom(fieldTargetType)){
                        field.set(object, Long.parseLong(parameterValue[0]));
                    }else if(long.class.isAssignableFrom(fieldTargetType)){
                        field.set(object, Integer.parseInt(parameterValue[0]));
                    }else if(Float.class.isAssignableFrom(fieldTargetType)){
                        field.set(object, Float.parseFloat(parameterValue[0]));
                    }else if(float.class.isAssignableFrom(fieldTargetType)){
                        field.set(object, Integer.parseInt(parameterValue[0]));
                    }else if(Double.class.isAssignableFrom(fieldTargetType)){
                        field.set(object, Double.parseDouble(parameterValue[0]));
                    }else if(double.class.isAssignableFrom(fieldTargetType)){
                        field.set(object, Double.parseDouble(parameterValue[0]));
                    }
